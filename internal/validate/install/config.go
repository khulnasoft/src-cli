...
func DefaultConfig() *ValidationSpec {
	return &ValidationSpec{
		SearchQuery: []string{
			"repo:^github.com/khulnasoft/src-cli$ config",
			"repo:^github.com/khulnasoft/src-cli$@4.0.0 config",
			"repo:^github.com/khulnasoft/src-cli$ type:symbol config",
		},
		ExternalService: ExternalService{
			...
			Config: Config{
				GitHub: GitHub{
					...
					Token: "",
					Orgs:  []string{},
					Repos: []string{"khulnasoft/src-cli"},
				},
			},
			MaxRetries:          5,
