...
func TestTaskExecTUI_Integration(t *testing.T) {
	...
	tasks := []*executor.Task{
		{Repository: &graphql.Repository{Name: "github.com/khulnasoft/khulnasoft"}},
		{Repository: &graphql.Repository{Name: "github.com/khulnasoft/src-cli"}},
	...
	expectOutput(t, buf, []string{
		...
		"│                                                                               ",
		"├── github.com/khulnasoft/khulnasoft  ...                                   0s",
		"├── github.com/khulnasoft/src-cli      ...                                   0s",
	...
	expectOutput(t, buf, []string{
		"⠋  Executing... (0/4, 0 errored)                                              0%",
		"│                                                                               ",
		"├── github.com/khulnasoft/khulnasoft  echo Hello World > README.md          0s",
		"├── github.com/khulnasoft/src-cli      Downloading archive                   0s",
	...
	expectOutput(t, buf, []string{
		"⠋  Executing... (0/4, 0 errored)                                              0%",
		"│                                                                               ",
		"├── github.com/khulnasoft/khulnasoft  gofmt                                 0s",
		"├── github.com/khulnasoft/src-cli      echo Hello World > README.md          0s",
		"└── github.com/sourcegraph/automati...  echo Hello World > README.md          0s",
		"",
	})
	...
	expectOutput(t, buf, []string{
		...
		"│                                                                               ",
		"├── github.com/khulnasoft/khulnasoft  Done!                                 0s",
		"├── github.com/khulnasoft/src-cli      echo Hello World > README.md          0s",
		"└── github.com/sourcegraph/automati...  Done!                                 0s",
		"",
	})
...
func TestProgressUpdateAfterComplete(t *testing.T) {
	...
	expectOutput(t, buf, []string{
		...
		"│                                                                               ",
		"├── github.com/khulnasoft/khulnasoft  exit 42                               0s",
		"└── github.com/khulnasoft/src-cli      Downloading archive                   0s",
		"",
	})
}
