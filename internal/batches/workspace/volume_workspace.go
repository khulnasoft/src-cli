...
import (
	...
	"github.com/khulnasoft/src-cli/internal/exec"
	"github.com/khulnasoft/src-cli/internal/version"
)
...
func (w *dockerVolumeWorkspace) Diff(ctx context.Context) ([]byte, error) {
	...
	// See: https://github.com/khulnasoft/khulnasoft/blob/82d5e7e1562fef6be5c0b17f18631040fd330835/enterprise/internal/campaigns/service.go#L324-L329
	//
