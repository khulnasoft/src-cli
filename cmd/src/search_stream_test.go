...
import (
	...
	"github.com/khulnasoft/src-cli/internal/streaming"
)
...
var event = []streaming.EventMatch{
	...
	&streaming.EventSymbolMatch{
		...
		Symbols: []streaming.Symbol{
			{
				URL:           "github.com/khulnasoft/khulnasoft/-/blob/cmd/frontend/graphqlbackend/search_results.go#L1591:26-1591:35",
				Name:          "doResults",
				ContainerName: "",
				Kind:          "FUNCTION",
			},
