...
Examples:
  ...
  Update a codeowners file for the repository "github.com/khulnasoft/khulnasoft":

    	$ src codeowners update -repo='github.com/khulnasoft/khulnasoft' -f CODEOWNERS

  Update a codeowners file for the repository "github.com/khulnasoft/khulnasoft" from stdin:

    	$ src codeowners update -repo='github.com/khulnasoft/khulnasoft' -f -
`
